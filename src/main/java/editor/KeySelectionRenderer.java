...
public abstract class KeySelectionRenderer extends BasicComboBoxRenderer implements JComboBox.KeySelectionManager {
	...
	/**
	 * This class can be used as the renderer and KeySelectionManager for an Object
	 * added to the ComboBoxModel.
	 * 
	 * <p>
	 ...
	 * JComboBox. The same String will be used to do key selection of an item in the
	 * ComboBoxModel.
	 * 
	 * @param box A JComboBox object that is to use this KeySelectionRenderer.
	 */
