...
public class Obstacle {
	...
	public void reset() {
		...
		case 0x00: // Small Tree
			this.dialogue[0] = NewDialogue.createText(
			...
			break;
		case 0x01: // Logs
			this.dialogue[0] = NewDialogue.createText("A pile of wooden logs. That's where raw materials are get.",
					NewDialogue.MAX_STRING_LENGTH, NewDialogue.DIALOGUE_SPEECH, false);
			break;
		case 0x02: // Planks
			this.dialogue[0] = NewDialogue.createText("Some wooden planks. Used in the house construction.",
					NewDialogue.MAX_STRING_LENGTH, NewDialogue.DIALOGUE_SPEECH, false);
			break;
		...
		case 0x07: // Workbench Right
			this.dialogue[0] = NewDialogue.createText("Workbench table. This is where raw materials are refined.",
					NewDialogue.MAX_STRING_LENGTH, NewDialogue.DIALOGUE_SPEECH, false);
			break;
		case 0x08: // Dead small tree
			this.dialogue[0] = NewDialogue.createText("This tree looks barren.", NewDialogue.MAX_STRING_LENGTH,
					NewDialogue.DIALOGUE_SPEECH, false);
			this.dialogue[1] = NewDialogue.createText("Want to pick branches off?", NewDialogue.MAX_STRING_LENGTH,
					NewDialogue.DIALOGUE_QUESTION, false);
			this.dialogue[2] = NewDialogue.createText("Wooden logs have been picked.", NewDialogue.MAX_STRING_LENGTH,
					NewDialogue.DIALOGUE_SPEECH, false);
			break;
		}
	}
