...
// case Character.UP:
// OverWorld.this.currentArea.setPixelData(data, OverWorld.this.player.getXInArea(),
...
// break;
// case Character.LEFT:
// OverWorld.this.currentArea.setPixelData(data, OverWorld.this.player.getXInArea() - 1,
